<template>
    <div class="loginContainer">
        ...
        <router-link to="/register" class="register_forget" v-if="!loginWay">注册</router-link>
        <router-link to="/forget" class="register_forget" v-if="!loginWay">重置密码</router-link>
