        ...
        <section>
            <section class="profile-number">
                <router-link :to="userInfo&&userInfo.id? '/profile/info' : '/login'" class="profile-link">
                    <img src="../../images/touxiang.jpg" class="privateImage" v-if="userInfo&&userInfo.id">
                    <!-- <img :src="require('../images/qq.png')" v-if="userInfo&&userInfo.id"> -->
            ...
            <section class="profile-1reTe">
                <router-link to='/order' class="myorder">
                    <aside>
                        <svg fill="#4aa5f0">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-jilu"></use>
                        </svg>
                    </aside>
                ...
                <a href='' class="myorder">
                    <aside>
                        <svg fill="#fc7b53">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-xinxi"></use>
                        </svg>
                    </aside>
                    <div class="myorder-div">
                        <span>个人信息完善</span>
                ...
                <router-link to='/' class="myorder">
                    <aside>
                        <svg fill="#ffc636">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-shebei"></use>
                        </svg>
                    </aside>
                    <div class="myorder-div">
                        <span>设备管理</span>
            ...
            <section class="profile-1reTe">
                <router-link to='/service' class="myorder">
                    <aside>
                        <svg fill="#4aa5f0">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-bangzhu"></use>
                        </svg>
                    </aside>
                    <div class="myorder-div">
                        <span>帮助反馈</span>
                ...
                <router-link to='/download' class="myorder">
                    <aside>
                        <svg fill="#3cabff">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-guangyu"></use>
                        </svg>
                    </aside>
