<template>
    <div>
      ...
      <el-container class="home_grade_container">
        <el-main class="home_grade"><el-progress type="circle" :percentage="85" status="text" class="grade">85分</el-progress></el-main>
      </el-container>

			<el-container class="home_cal_container">
        <el-main class="home_cal">
					<el-row :gutter="20">
						<el-col :span="12"><div class="grid-content bg-purple"><h4>今日测量</h4><p>2小时32分钟</p></div></el-col>
						<el-col :span="12"><div class="grid-content bg-purple"><h4>今日分析</h4><p>暂无异常</p></div></el-col>
					</el-row>
				</el-main>
      </el-container>
								...
								var myChart = echarts.init(dom);
									...
									myChart.setOption({
											...
											xAxis: {
													...
													//假数据
													data: ["2018-03-01","2018-03-02","2018-03-03","2018-03-04","2018-03-05","2018-03-06","2018-03-07","2018-03-08","2018-03-09","2018-03-10","2018-03-011","2018-03-12","2018-03-13","2018-03-14","2018-03-15","2018-03-16","2018-03-17","2018-03-18","2018-03-19","2018-03-20"],
											},
											yAxis: {
													splitLine: {
															show: false
